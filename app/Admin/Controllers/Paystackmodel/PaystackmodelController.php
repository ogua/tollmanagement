...
class PaystackmodelController extends AdminController
{
    /**
    ...
    protected function grid()
    {
        ...
        $grid->filter(function($filter){
            ...
            // $filter->equal('tollpoint.region', 'Region')->select(['1' => 'Active Members', '0' => 'Stopped Members']);

            // $filter->equal('tollpoint.name', __('Location'))->select(['1' => 'Active Members', '0' => 'Stopped Members']);
